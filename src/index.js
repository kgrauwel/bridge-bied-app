const APP_VERSION = "2026-06-17-player-lobby-v3";
...
async function handleApi(request, env) {
  ...
  try {
    ...
    if (request.method === "GET" && url.pathname === "/api/sessions") {
      return json({ players: playerList(registry), sessions: sessionsForPlayer(registry, playerName) });
    }
